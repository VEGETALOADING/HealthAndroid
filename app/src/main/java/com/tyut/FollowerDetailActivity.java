...
public class FollowerDetailActivity extends AppCompatActivity implements OnClickListener
{
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            switch (msg.what){
                case 0:
                    ...
                    Glide.with(FollowerDetailActivity.this).load("http://192.168.1.4:8080/userpic/" + vo.getUserpic()).into(user_photo);
    ...
    protected void onResume() {
        ...
        OkHttpUtils.get("http://192.168.1.4:8080/portal/user/search.do?id="+current_followerId,
                new OkHttpCallback(){
                    @Override
        ...
        OkHttpUtils.get("http://192.168.1.4:8080/portal/follow/findfollowercount.do?id=" + current_followerId,
                new OkHttpCallback(){
                    @Override
                    public void onFinish(String status, String msg) {
                        super.onFinish(status, msg);
        ...
        OkHttpUtils.get("http://192.168.1.4:8080/portal/follow/findfollowingcount.do?followerid=" + current_followerId,
                new OkHttpCallback(){
                    @Override
                    public void onFinish(String status, String msg) {
                        super.onFinish(status, msg);
        ...
        OkHttpUtils.get("http://192.168.1.4:8080/portal/activity/findactivitycount.do?userid=" + current_followerId,
                new OkHttpCallback(){
                    @Override
                    public void onFinish(String status, String msg) {
                        super.onFinish(status, msg);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.follower_isFollow_btn:
                OkHttpUtils.get("http://192.168.1.4:8080/portal/follow/followornot.do?id=" + current_followerId + "&followerid=" + userVO.getId(),
                        new OkHttpCallback(){
                            @Override
                            public void onFinish(String status, String msg) {
                                super.onFinish(status, msg);
