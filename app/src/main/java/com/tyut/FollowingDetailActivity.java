...
public class FollowingDetailActivity extends AppCompatActivity implements OnClickListener
{
    ...
    protected void onResume() {
        ...
        OkHttpUtils.get("http://192.168.1.4:8080/portal/user/search.do?id="+current_followingId,
                new OkHttpCallback(){
                    @Override
        ...
        OkHttpUtils.get("http://192.168.1.4:8080/portal/follow/findfollowercount.do?id=" + current_followingId,
                new OkHttpCallback(){
                    @Override
                    public void onFinish(String status, String msg) {
                        super.onFinish(status, msg);
        ...
        OkHttpUtils.get("http://192.168.1.4:8080/portal/follow/findfollowingcount.do?followerid=" + current_followingId,
                new OkHttpCallback(){
                    @Override
                    public void onFinish(String status, String msg) {
                        super.onFinish(status, msg);
        ...
        OkHttpUtils.get("http://192.168.1.4:8080/portal/activity/findactivitycount.do?userid=" + current_followingId,
                new OkHttpCallback(){
                    @Override
                    public void onFinish(String status, String msg) {
                        super.onFinish(status, msg);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.following_isFollow_btn:
                ...
                OkHttpUtils.get("http://192.168.1.4:8080/portal/follow/followornot.do?id=" + current_followingId + "&followerid=" + userVO.getId(),
                        new OkHttpCallback(){
                            @Override
                            public void onFinish(String status, String msg) {
                                super.onFinish(status, msg);
