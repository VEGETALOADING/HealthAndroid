    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.return_k:
                ...
                switch (src){
                    case 0:
                        DietAndSportActivity.this.startActivity(new Intent(DietAndSportActivity.this, HomeActivity.class));
                        break;
                    case 1:
                        DietAndSportActivity.this.startActivity(new Intent(DietAndSportActivity.this, RecordActivity.class));
                        break;
                }
                this.finish();
                break;
