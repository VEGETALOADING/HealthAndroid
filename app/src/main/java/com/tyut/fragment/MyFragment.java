...
public class MyFragment extends Fragment implements View.OnClickListener {
    ...
    public void onResume() {
        ...
        if(isLogin == true){
            ...
            Glide.with(this).load("http://"+this.getString(R.string.localhost)+"/userpic/" + userVO.getUserpic()).into(user_photo);


            OkHttpUtils.get("http://"+this.getString(R.string.localhost)+"/portal/follow/findfollowercount.do?id=" + userVO.getId(),
                    new OkHttpCallback(){
                        @Override
            ...
            OkHttpUtils.get("http://"+this.getString(R.string.localhost)+"/portal/follow/findfollowingcount.do?followerid=" + userVO.getId(),
                    new OkHttpCallback(){
                        @Override
                        public void onFinish(String status, String msg) {
                            super.onFinish(status, msg);
            ...
            OkHttpUtils.get("http://"+this.getString(R.string.localhost)+"/portal/activity/findactivitycount.do?userid=" + userVO.getId(),
                    new OkHttpCallback(){
                        @Override
                        public void onFinish(String status, String msg) {
                            super.onFinish(status, msg);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.logout_btn:
                ...
                OkHttpUtils.get("http://"+this.getString(R.string.localhost)+"/portal/user/logout.do",
                        new OkHttpCallback(){
                            @Override
                            public void onFinish(String status, String msg) {
                                super.onFinish(status, msg);
