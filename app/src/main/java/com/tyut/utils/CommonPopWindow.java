...
public class CommonPopWindow {
    ...
    public interface ViewClickListener {
        void getChildView(PopupWindow mPopupWindow, View view, int mLayoutResId, int name, String defaultIndex);
    }
...
//                mPopupWindow.showAsDropDown(view, 0, -(getHeight() + view.getMeasuredHeight()));
    ...
    public static class Builder implements PopupWindow.OnDismissListener {
        ...
        public CommonPopWindow build(Context context, int name, String defaultIndex) {
            ...
            if (mListener != null && mLayoutResId != 0) {
                mListener.getChildView(mPopupWindow, mContentView, mLayoutResId, name, defaultIndex);
            }
            return popWindow;
        }
        ...
        private void apply() {
            ...
            } else mPopupWindow.setBackgroundDrawable(new ColorDrawable());
