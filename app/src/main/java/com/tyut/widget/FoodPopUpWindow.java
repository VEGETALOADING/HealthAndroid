...
public class FoodPopUpWindow implements View.OnClickListener {
    ...
    private void initScrollPick(){
        ...
        if(myfoodVO == null) {
            ...
            chooseDate_spv.setSelected(dateList.indexOf(myfoodVO.getCreateTime()));
            dateIndex = dateList.indexOf(myfoodVO.getCreateTime());
            chooseTime_spv.setSelected(timeList.indexOf(myfoodVO.getType()-1));
        }
    ...
    private void initView(){
        ...
        Glide.with(context).load("http://192.168.1.4:8080/foodpic/" + foodPic).into(food_pic);
