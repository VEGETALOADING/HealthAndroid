    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.confirm_recordgirth_tv:
                OkHttpUtils.get("http://"+context.getString(R.string.url)+":8080/portal/girth/add.do?userid="+userId+"&type="+type+"&value="+getLength()+"&createTime="+dateWithYearList.get(dateIndex),
                        new OkHttpCallback(){
                            @Override
